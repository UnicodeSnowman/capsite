...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handlersRoot = __webpack_require__(197);
	
	var _handlersRoot2 = _interopRequireDefault(_handlersRoot);
	...
	exports['default'] = _react2['default'].createElement(
	    _reactRouter.Route,
	    { handler: _handlersRoot2['default'], path: '/' },
	    _react2['default'].createElement(_reactRouter.Route, { handler: _componentsApp2['default'], name: 'elsewhere', path: 'elsewhere' }),
	    _react2['default'].createElement(_reactRouter.Route, { handler: _componentsApp2['default'], name: 'thingGenerator', path: 'things' })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* do you even blog bro? */ /* 
	                            ...
	                            */ /* display random record cover from discogs collection? also link to full collection */ /* maybe also a generator to pick an album from my collection at random */ /* description of stereo gear/setup... maybe guitar world-style gear diagram? */ /* Flag Day ? */ /* guitar pedals */ /* 
